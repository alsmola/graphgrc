...
- `custom/` - Custom security controls
- `standards/` - Security standards
- `processes/` - Operational processes
- `policies/` - Security policies
- `charter/` - Program charter documents

**Note:** Framework directories (soc2, gdpr, iso27001, etc.) are NOT scanned for links - they only receive backlinks from custom controls.
...
```
Source: /custom/acc-01.md
  Links to: /standards/aws-security-standard.md
    Annotation: "IAM Identity Center for cloud access"

Target: /standards/aws-security-standard.md
  Referenced by: /custom/acc-01.md
    Annotation: "IAM Identity Center for cloud access"
```
...
- [ACC-02 - Authorization](../custom/acc-02.md) ^[IAM role-based access]
...
- **Controls** - Custom security controls from `/custom`
...
1. **Write a custom control** with annotated links:
...
**Standards:**
- [SaaS IAM Standard](../standards/saas-iam-standard.md) ^[SSO and MFA requirements]

## Framework Mappings

**SOC 2:**
- [CC6.1](../soc2/cc61.md) ^[Strong authentication implements logical access security]
```
...
**Controls:**
- [ACC-01 - Identity & Authentication](../custom/acc-01.md) ^[SSO and MFA requirements]
```

`soc2/cc61.md` now has:

```markdown
## Referenced By

**Controls:**
- [CC6.1](../custom/acc-01.md) ^[Strong authentication implements logical access security]
```
