...
### SOC 2
- [CC6.8](cc68.md) - EDR and antivirus protect endpoints from malicious software and unauthorized modifications
- [CC7.2](cc72.md) - EDR continuously monitors endpoints for anomalies indicative of malicious acts

### GDPR
- [Article 32](art32.md) - Endpoint protection (EDR, antivirus, encryption, USB restrictions) are technical measures ensuring security of processing
