...
### SOC 2
- [CC7.2](cc72.md) - Centralized logging and monitoring detect anomalies indicative of malicious acts, natural disasters, or errors
- [CC7.3](cc73.md) - Log analysis and alerting enable evaluation of security events and timely response

### GDPR
- [Article 32](art32.md) - Logging and monitoring enable detection of, and ability to respond to, security incidents affecting personal data
