...
### SOC 2
- [CC9.2](cc92.md) - Vendor contracts establish security and privacy obligations for subservice organizations

### GDPR
- [Article 28](art28.md) - Data Processing Agreements (DPAs) are required contracts between controller and processor defining data processing obligations
...
**Processes:**
- [Vendor Risk Assessment Process](../processes/vendor-risk-assessment-process.md) ^[Legal review negotiates DPA, security terms, breach notification, data deletion, and audit rights]
