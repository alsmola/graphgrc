...
### SOC 2
- [CC6.6](cc66.md) - MDM enforces security policies restricting device configuration and ensuring compliance
- [CC6.7](cc67.md) - MDM remote wipe restricts removal of information on lost/stolen devices
- [CC7.2](cc72.md) - MDM monitoring detects non-compliant devices that could indicate security issues

### GDPR
- [Article 32](art32.md) - MDM enforcement of encryption, screen locks, and updates are technical measures ensuring security of processing
