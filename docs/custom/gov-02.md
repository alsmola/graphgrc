...
### SOC 2
- [CC3.1](cc31.md) - Risk assessment process identifies risks to achieving security objectives
- [CC3.2](cc32.md) - Risk assessment considers internal and external factors and their impact on security
- [CC3.4](cc34.md) - Risk assessment considers potential for fraud in evaluating security risks

### GDPR
- [Article 32](art32.md) - Risk assessment determines appropriate technical and organizational measures based on risk level
