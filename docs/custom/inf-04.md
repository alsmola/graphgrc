...
### SOC 2
- [A1.2](a12.md) - Regular backups and disaster recovery procedures ensure availability commitments are met
- [CC9.1](cc91.md) - Business continuity planning includes backup and recovery capabilities for critical systems

### GDPR
- [Article 32](art32.md) - Backup and recovery capabilities ensure resilience and ability to restore availability and access to data after incident
...
**Processes:**
- [Backup and Recovery Process](../processes/backup-recovery-process.md) ^[7-step backup process: scope definition, automated configuration, monitoring, security (encryption/access control), quarterly recovery testing, annual DR drill, documentation]
