...
- [Vulnerability Management Process](../controls/vulnerability-management/vulnerability-management-process.md) ^[MTTR targets by severity: Critical <7d, High <30d, Medium <90d, open Critical/High target 0/5]
