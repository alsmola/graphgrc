...
**Controls:**
- [DAT-02: Encryption](../../custom/dat-02.md) ^[Encryption can reduce breach notification requirements - encrypted data may not require notification to data subjects]
- [OPS-03: Incident Response](../../custom/ops-03.md) ^[Process for notifying data subjects of breaches when high risk to their rights and freedoms]
