---
id: infrastructure-security-network-security
type: control
...
### SOC 2
- [CC6.6](../../frameworks/soc2/cc66.md) ^[Network security implements boundary protection systems and restricts external access]
- [CC6.1](../../frameworks/soc2/cc61.md) ^[Network controls restrict logical access and manage points of access]

### GDPR
- [Article 32](../../frameworks/gdpr/art32.md) ^[Network security is a technical measure protecting confidentiality and integrity of personal data]
...
**Standards:**
- [standard-aws-security: AWS Security Standard](../../standards/aws-security-standard.md) ^[No publicly accessible RDS, VPC endpoints for AWS services]
