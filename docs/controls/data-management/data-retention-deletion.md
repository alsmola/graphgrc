---
id: data-management-data-retention-deletion
type: control
...
**Standards:**
- [standard-data-retention: Data Retention Standard](../../standards/data-retention-standard.md) ^[Retention periods for customer data, employee data, logs, and business records]
