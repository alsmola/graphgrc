...
**Standards:**
- [standard-aws-security: AWS Security Standard](../../standards/aws-security-standard.md) ^[Root account MFA with hardware token stored in vault, CloudTrail logging]
- [standard-logging-monitoring: Logging and Monitoring Standard](../../standards/logging-monitoring-standard.md) ^[CloudTrail logs all admin API calls, alerts on root account login and IAM policy changes]
