...
Process for penetration testing.

## Purpose

Define steps and responsibilities for penetration testing.
...
- [External Audits](../controls/compliance/external-audits.md) ^[Pentest reports provided as evidence of security testing for SOC 2 audits]
- [Bug Bounty Program](../controls/security-assurance/bug-bounty-program.md) ^[Bug bounty complements annual pentests with continuous crowdsourced vulnerability discovery, findings triaged using same severity/remediation process]
