...
|                            | a capability to authorize      |
|                            | physical access to facilities  |
|                            | based on the position or role  |
|                            | of the individual.             |
...
|                            | controls. •	IT personnel        |
|                            | implement appropriate          |
|                            | physical security practices to |
...
|                            | IAM integrates into physical   |
|                            | access using a holistic        |
...
| Continuously improving     | Physical & Environmental       |
|                            | Security (PES) efforts are     |
