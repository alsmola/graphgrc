...
|                            | capability to restrict the use |
|                            | of types of digital media on   |
|                            | systems or system components.  |
| Performed internally       | SP-CMM1 is N/A, since a        |
|                            | structured process is required |
|                            | to restrict the use of types   |
|                            | of digital media on systems or |
|                            | system components.             |
...
|                            | restrict the use of types of   |
|                            | digital media on systems or    |
|                            | system components.             |
