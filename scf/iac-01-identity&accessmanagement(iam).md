...
|                            | to logical access control. •	A  |
|                            | steering committee is formally |
|                            | established to provide         |
|                            | executive oversight of the     |
|                            | cybersecurity & data privacy   |
|                            | program, including logical     |
|                            | access control. •	An IT Asset   |
|                            | Management (ITAM) function, or |
|                            | similar function: o	Categorizes |
...
|                            | OEM security guides). o	Uses    |
|                            | a Configuration Management     |
|                            | Database (CMDB), or similar    |
|                            | tool, as the authoritative     |
|                            | source of IT assets configured |
