...
|                            | or licenses/product keys are   |
|                            | stored locally in a fire-rated |
|                            | container.                     |
...
|                            | to store backup copies of      |
|                            | critical software and other    |
|                            | security-related information   |
|                            | in a separate facility or in   |
|                            | a fire-rated container that is |
|                            | not collocated with the system |
|                            | being backed up.               |
