...
|                            | a capability to resume         |
|                            | all missions and business      |
|                            | functions within Recovery      |
|                            | Time Objectives (RTOs) of the  |
|                            | contingency plan's activation. |
...
|                            | to resume all missions and     |
|                            | business functions within      |
|                            | Recovery Time Objectives       |
|                            | (RTOs) of the contingency      |
|                            | plan's activation.             |
