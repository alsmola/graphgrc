...
|                            | capability to require system   |
|                            | developers and integrators     |
|                            | to create a Security Test      |
|                            | and Evaluation (ST&E) plan     |
|                            | and implement the plan under   |
|                            | the witness of an independent  |
|                            | party.                         |
| Performed internally       | SP-CMM1 is N/A, since a        |
|                            | structured process is required |
|                            | to require system developers   |
|                            | and integrators to create a    |
|                            | Security Test and Evaluation   |
|                            | (ST&E) plan and implement the  |
|                            | plan under the witness of an   |
|                            | independent party.             |
