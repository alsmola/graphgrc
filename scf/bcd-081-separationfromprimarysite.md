...
|                            | capability to separate the     |
|                            | alternate storage site from    |
...
|                            | to separate the alternate      |
|                            | storage site from the primary  |
|                            | storage site to reduce         |
...
|                            | organization acquires space    |
|                            | to serve as the alternate      |
|                            | site that is in a different    |
|                            | geographic zone from the       |
|                            | inaccessible facility (e.g.,   |
|                            | dedicated facility or cloud    |
|                            | instance).                     |
...
|                            | separate the alternate storage |
|                            | site from the primary storage  |
|                            | site to reduce susceptibility  |
|                            | to similar threats.            |
