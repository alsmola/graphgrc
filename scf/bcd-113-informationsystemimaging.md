...
|                            | (e.g., redundant ISPs,         |
|                            | redundant power, etc.).<br>-   |
|                            | IT personnel have a limited    |
|                            | capability to re-image,        |
|                            | or configure, assets from      |
|                            | configuration-controlled and   |
|                            | integrity-protected images     |
...
|                            | IT personnel use technology to |
|                            | re-image, or configure, assets |
|                            | from configuration-controlled  |
|                            | and integrity-protected images |
|                            | or scripts (infrastructure as  |
|                            | code).                         |
