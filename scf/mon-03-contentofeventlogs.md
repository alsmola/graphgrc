...
|                            | systems to produce event       |
|                            | logs that contain sufficient   |
|                            | information to, at a           |
|                            | minimum:<br> - Establish what  |
|                            | type of event occurred;<br>    |
|                            | - When (date and time) the     |
|                            | event occurred;<br> - Where    |
|                            | the event occurred;<br> - The  |
|                            | source of the event;<br> - The |
|                            | outcome (success or failure)   |
|                            | of the event; and <br> - The   |
...
|                            | configure systems to produce   |
|                            | event logs that contain        |
|                            | sufficient information         |
|                            | to, at a minimum:<br> -        |
|                            | Establish what type of         |
|                            | event occurred;<br> - When     |
|                            | (date and time) the event      |
|                            | occurred;<br> - Where the      |
|                            | event occurred;<br> - The      |
|                            | source of the event;<br> - The |
|                            | outcome (success or failure)   |
|                            | of the event; and <br> - The   |
|                            | identity of any user/subject   |
