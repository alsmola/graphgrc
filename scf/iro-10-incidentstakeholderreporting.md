...
|                            | technologies exist to report   |
|                            | incidents both internally      |
|                            | to organizational incident     |
|                            | response personnel (within     |
|                            | defined time-periods) and      |
|                            | externally to governmental     |
...
|                            | to timely-report incidents     |
|                            | to applicable:  - Internal     |
|                            | stakeholders;   - Affected     |
|                            | clients & third-parties; and   |
|                            | - Regulatory authorities.      |
