...
- [P6.7](../soc2/p67.md)
### GDPR
- [Art 33.1](../gdpr/art331.md)
- [Art 33.2](../gdpr/art332.md)
- [Art 33.3](../gdpr/art333.md)
- [Art 33.4](../gdpr/art334.md)
- [Art 33.5](../gdpr/art335.md)
...
|                            | capability to timely-report    |
|                            | incidents to applicable:<br>   |
|                            | - Internal stakeholders;       |
|                            | <br> - Affected clients &      |
|                            | third-parties; and<br> -       |
|                            | Regulatory authorities.        |
| Performed internally       | Incident Response (IRO)        |
...
|                            | process to facilitate incident |
...
|                            | incident response operations.  |
|                            | <br>o	Implement and maintain an |
...
|                            | document, manage and report    |
|                            | on actual and potential        |
|                            | cybersecurity & data privacy   |
|                            | incidents.<br>- Administrative |
|                            | processes and technologies     |
|                            | exist to maintain incident     |
|                            | response contacts with         |
|                            | applicable regulatory and law  |
...
|                            | that can perform coordinated   |
|                            | incident response.<br>- The    |
|                            | ISIRT, or similar function,    |
|                            | develops and maintains a       |
|                            | documented, program-level      |
|                            | Integrated Incident Response   |
|                            | Program (IIRP) that provides   |
|                            | operational and tactical-level |
|                            | guidance for cybersecurity     |
|                            | & data privacy response        |
|                            | operations.<br>- A Security    |
...
|                            | to the data the asset          |
|                            | stores, transmits and/ or      |
|                            | processes and provides that    |
|                            | information to the SOC for     |
|                            | Incident Response Operations   |
|                            | (IRO).<br>- Administrative     |
|                            | processes and technologies     |
|                            | exist to report incidents both |
|                            | internally to organizational   |
|                            | incident response personnel    |
|                            | (within defined time-periods)  |
|                            | and externally to governmental |
|                            | authorities and affected       |
|                            | parties, as necessary.<br>-    |
|                            | Administrative processes and   |
|                            | technologies exist to maintain |
|                            | incident response contacts     |
|                            | with applicable regulatory and |
...
|                            | timely-report incidents to     |
|                            | applicable:<br> - Internal     |
|                            | stakeholders; <br> - Affected  |
