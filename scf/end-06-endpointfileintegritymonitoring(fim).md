...
|                            | on all technology assets       |
|                            | that can run Anti-malware      |
|                            | software.  •	Data management is |
|                            | decentralized.                 |
...
| Continuously improving     | Endpoint Security (END)        |
