...
|                            | data to the alternate site     |
|                            | at a rate that is capable      |
|                            | of meeting Recovery Time       |
|                            | Objectives (RTOs) and          |
|                            | Recovery Point Objectives      |
|                            | (RPOs).<br>- the organization  |
...
|                            | transfer backup data to an     |
|                            | alternate site at a rate that  |
|                            | is capable of meeting RTOs     |
|                            | and RPOs.<br>- organization    |
|                            | acquires space to serve as     |
|                            | the alternate site that is in  |
|                            | a different geographic zone    |
|                            | from the inaccessible facility |
|                            | (e.g., dedicated facility      |
|                            | or cloud instance).<br>- IT    |
|                            | personnel backup copies of     |
|                            | business-critical software,    |
|                            | licenses/keys and other        |
|                            | security-related information   |
...
|                            | to operations.<br>- Data       |
|                            | centers have alternate         |
|                            | telecommunications             |
