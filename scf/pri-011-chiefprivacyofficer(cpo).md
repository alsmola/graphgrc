...
|                            | a capability to appoint        |
|                            | a Chief Privacy Officer        |
|                            | (CPO) or similar role, with    |
|                            | the authority, mission,        |
|                            | accountability and resources   |
|                            | to coordinate, develop and     |
|                            | implement, applicable data     |
|                            | privacy requirements and       |
|                            | manage data privacy risks      |
|                            | through the organization-wide  |
|                            | data privacy program.          |
| Performed internally       | SP-CMM1 is N/A, since a        |
|                            | structured process is required |
|                            | to appoint a Chief Privacy     |
|                            | Officer (CPO) or similar role, |
|                            | with the authority, mission,   |
|                            | accountability and resources   |
|                            | to coordinate, develop and     |
|                            | implement, applicable data     |
|                            | privacy requirements and       |
