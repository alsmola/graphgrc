...
|                            | o	Monitors the organization     |
|                            | for Indicators of Compromise   |
|                            | (IoC) and provides 24x7x365    |
|                            | near real-time alerting        |
|                            | capability. o	Is configured     |
|                            | to alert incident response     |
|                            | personnel of detected          |
|                            | suspicious events such that    |
|                            | incident responders can        |
|                            | look to terminate suspicious   |
|                            | events. •	A Security Operations |
|                            | Center (SOC), or similar       |
|                            | function, enables incident     |
...
|                            | for unauthorized activities to |
