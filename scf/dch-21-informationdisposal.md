...
|                            | dispose of, destroy or erase   |
|                            | information.                   |
| Performed internally       | SP-CMM1 is N/A, since a        |
|                            | structured process is required |
|                            | to securely dispose of,        |
|                            | destroy or erase information.  |
...
|                            | research. •	Physical controls,  |
|                            | administrative processes and   |
|                            | technologies:  o	Physically     |
|                            | secure all media that contains |
|                            | sensitive/regulated data.      |
|                            | o	Restrict access to digital    |
|                            | and non-digital media to       |
|                            | authorized individuals.        |
|                            | o	Restrict the types, usage and |
|                            | distribution of digital media. |
|                            | o	Securely dispose of, destroy  |
