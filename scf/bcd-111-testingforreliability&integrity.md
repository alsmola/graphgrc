...
|                            | a capability to routinely      |
|                            | test backups that verify the   |
...
|                            | power, etc.).<br>- A random    |
|                            | sampling of backups is tested  |
|                            | at least annually to verify    |
|                            | integrity and recoverability   |
|                            | of backed up data.<br>- Backup |
|                            | media for sensitive/regulated  |
...
|                            | routinely test backups that    |
|                            | verify the reliability of the  |
|                            | backup process, as well as the |
|                            | integrity and availability of  |
|                            | the data.                      |
