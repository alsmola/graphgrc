...
|                            | / Protection Systems (WIDS     |
|                            | / WIPS) to identify rogue      |
|                            | wireless devices and to detect |
|                            | attack attempts via wireless   |
|                            | networks.                      |
| Performed internally       | SP-CMM1 is N/A, since a        |
|                            | structured process is required |
|                            | to utilize Wireless Intrusion  |
|                            | Detection / Protection Systems |
|                            | (WIDS / WIPS) to identify      |
|                            | rogue wireless devices and     |
|                            | to detect attack attempts via  |
|                            | wireless networks.             |
