...
|                            | Assessment (DPIA) on systems,  |
|                            | applications and services      |
|                            | that store, process and/ or    |
|                            | transmit Personal Data (PD)    |
...
|                            | services that store, process   |
|                            | and/ or transmit Personal Data |
|                            | (PD) to identify and remediate |
|                            | reasonably-expected risks.     |
