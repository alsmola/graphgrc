...
|                            | authorized devices on certain  |
|                            | services, protocols and ports. |
| Performed internally       | SP-CMM1 is N/A, since a        |
|                            | structured process is required |
|                            | to utilize a Demilitarized     |
|                            | Zone (DMZ) to restrict inbound |
...
|                            | on certain services, protocols |
|                            | and ports.                     |
| Quantitatively controllled | Web Security (WEB) efforts     |
...
|                            | utilize a Demilitarized Zone   |
|                            | (DMZ) to restrict inbound      |
|                            | traffic to authorized devices  |
|                            | on certain services, protocols |
|                            | and ports.                     |
