...
|                            | use of Personal Data (PD) for  |
|                            | internal testing, training     |
|                            | and research that:  - Takes    |
|                            | measures to limit or minimize  |
|                            | the amount of PD used for      |
|                            | internal testing, training     |
|                            | and research purposes; and  -  |
|                            | Authorizes the use of PD when  |
|                            | such information is required   |
|                            | for internal testing, training |
|                            | and research.                  |
| Performed internally       | SP-CMM1 is N/A, since          |
|                            | a structured process is        |
|                            | required to address the use    |
|                            | of Personal Data (PD) for      |
|                            | internal testing, training     |
|                            | and research that:  - Takes    |
|                            | measures to limit or minimize  |
|                            | the amount of PD used for      |
...
|                            | collect, store, processes,     |
|                            | transmit share or use PD only  |
...
|                            | technologies collect, store,   |
|                            | processes, transmit share or   |
|                            | use PD only for the purposes   |
|                            | identified in the data privacy |
|                            | notice.                        |
...
|                            | address the use of Personal    |
|                            | Data (PD) for internal         |
|                            | testing, training and research |
|                            | that:  - Takes measures to     |
|                            | limit or minimize the amount   |
|                            | of PD used for internal        |
|                            | testing, training and research |
|                            | purposes; and  - Authorizes    |
|                            | the use of PD when such        |
|                            | information is required for    |
|                            | internal testing, training and |
|                            | research.                      |
