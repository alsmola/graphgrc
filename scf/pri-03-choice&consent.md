...
|                            | to its collection that:<br>-   |
|                            | Uses plain language and        |
|                            | provide examples to illustrate |
|                            | the potential data privacy     |
|                            | risks of the authorization;    |
|                            | and<br>- Provides a means      |
|                            | for users to decline the       |
|                            | authorization.<br>             |
