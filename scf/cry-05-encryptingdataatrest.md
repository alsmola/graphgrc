...
|                            | •	Mobile devices containing     |
|                            | sensitive/regulated data use   |
|                            | a cryptographic mechanism      |
|                            | to prevent the unauthorized    |
|                            | disclosure of information      |
|                            | at rest (e.g., whole drive     |
|                            | encryption).  •	IT personnel    |
...
|                            | safeguards. •	Mobile devices    |
|                            | containing sensitive/regulated |
|                            | data use a cryptographic       |
|                            | mechanism to prevent the       |
|                            | unauthorized disclosure of     |
|                            | information at rest (e.g.,     |
