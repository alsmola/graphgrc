...
|                            | to perform an independent      |
|                            | assessment of cybersecurity &  |
|                            | data privacy controls.<br>- Up |
|                            | on completing an assessment,   |
|                            | the GRC function generates     |
|                            | a formal report that           |
|                            | documents the assessment of    |
|                            | cybersecurity & data privacy   |
...
| Quantitatively controllled | Compliance (CPL) efforts are   |
