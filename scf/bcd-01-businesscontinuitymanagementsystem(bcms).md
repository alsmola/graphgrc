...
|                            | planning controls to help      |
|                            | ensure resilient assets and    |
|                            | services.                      |
...
|                            | for BC/DR management.<br>-     |
|                            | IT/cybersecurity personnel     |
|                            | work with business             |
|                            | stakeholders to identify       |
|                            | business-critical systems,     |
|                            | services, internal teams       |
...
|                            | incident within Recovery       |
|                            | Time Objectives (RTOs).<br>-   |
|                            | Within the BCPs, alternate     |
|                            | communications channels have   |
|                            | been defined and alternative   |
|                            | decision-makers are designated |
|                            | if primary decision-makers are |
|                            | unavailable.<br>- IT personnel |
|                            | use a backup methodology       |
|                            | (e.g., grandfather, father     |
|                            | & s on rotation) to store      |
|                            | backups in a secondary         |
|                            | location, separate from the    |
|                            | primary storage site.<br>-     |
...
|                            | strategy and security function |
|                            | objectives to determine        |
|                            | prioritization of and          |
|                            | authoritative guidance for     |
|                            | Business Continuity & Disaster |
|                            | Recovery (BC/DR) practices,    |
...
|                            | BC/DR and establishes a        |
|                            | clear and authoritative        |
|                            | accountability structure       |
|                            | for BC/DR operations.<br>-     |
...
|                            | functions are sustainable      |
|                            | both during and after an       |
|                            | incident within RTOs.<br>-     |
|                            | Within the BCPs, alternate     |
|                            | communications channels have   |
|                            | been defined and alternative   |
|                            | decision-makers are designated |
|                            | if primary decision-makers     |
|                            | are unavailable.<br>- The data |
