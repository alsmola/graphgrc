...
|                            | a capability to design,        |
|                            | implement and review firewall  |
|                            | and router configurations to   |
...
|                            | enforce the use of human       |
|                            | reviews for Access Control     |
...
| Continuously improving     | Network Security (NET)         |
