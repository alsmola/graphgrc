...
|                            | a capability to Facility       |
|                            | security utilize and maintain  |
|                            | fire suppression and detection |
|                            | devices/systems for the system |
|                            | that are supported by an       |
...
|                            | Facility security utilize and  |
|                            | maintain fire suppression and  |
|                            | detection devices/systems for  |
|                            | the system that are supported  |
|                            | by an independent energy       |
|                            | source.                        |
