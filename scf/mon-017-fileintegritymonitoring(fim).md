...
|                            | capability to utilize a File   |
|                            | Integrity monitor (FIM),       |
|                            | or similar change-detection    |
|                            | technology, on critical        |
|                            | assets to generate alerts for  |
...
|                            | to utilize a File Integrity    |
|                            | monitor (FIM), or similar      |
|                            | change-detection technology,   |
|                            | on critical assets to generate |
