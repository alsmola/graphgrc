...
|                            | specialized backup mechanisms  |
|                            | that will allow transaction    |
|                            | recovery for transaction-based |
|                            | applications and services in   |
|                            | accordance with Recovery Point |
|                            | Objectives (RPOs).             |
| Performed internally       | SP-CMM1 is N/A, since a        |
|                            | structured process is required |
|                            | to utilize specialized backup  |
|                            | mechanisms that will allow     |
|                            | transaction recovery for       |
