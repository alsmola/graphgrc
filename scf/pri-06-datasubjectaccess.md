...
|                            | subjects the ability to access |
|                            | their Personal Data (PD)       |
|                            | maintained in organizational   |
|                            | systems of records.            |
| Performed internally       | SP-CMM1 is N/A, since a        |
|                            | structured process is required |
|                            | to provide data subjects       |
|                            | the ability to access their    |
|                            | Personal Data (PD) maintained  |
|                            | in organizational systems of   |
|                            | records.                       |
...
|                            | provide data subjects the      |
|                            | ability to access their PD     |
|                            | maintained in organizational   |
|                            | systems of records.            |
