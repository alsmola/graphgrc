...
|                            | the secure recovery and        |
|                            | reconstitution of systems      |
|                            | to a known state after a       |
...
|                            | Recoveries are performed into  |
|                            | an isolated, non-production    |
|                            | environment.                   |
...
|                            | ensure the secure recovery     |
|                            | and reconstitution of systems  |
|                            | to a known state after a       |
|                            | disruption, compromise or      |
|                            | failure.                       |
