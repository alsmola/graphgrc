...
|                            | capability to routinely update |
|                            | risk assessments and react     |
|                            | accordingly up on identifying  |
|                            | new security vulnerabilities,  |
|                            | including using outside        |
|                            | sources for security           |
|                            | vulnerability information.     |
| Performed internally       | SP-CMM1 is N/A, since          |
|                            | a structured process is        |
|                            | required to routinely update   |
|                            | risk assessments and react     |
|                            | accordingly up on identifying  |
|                            | new security vulnerabilities,  |
|                            | including using outside        |
...
|                            | to routinely update risk       |
|                            | assessments and react          |
|                            | accordingly up on identifying  |
|                            | new security vulnerabilities,  |
|                            | including using outside        |
|                            | sources for security           |
