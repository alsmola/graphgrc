...
|                            | capability to maintain data    |
|                            | privacy-related records and    |
|                            | develop, disseminate and       |
|                            | update reports to internal     |
...
|                            | projects. •	Technologies are    |
|                            | configured to support records  |
|                            | management of for data subject |
|                            | authorizations.                |
...
|                            | maintain data privacy-related  |
|                            | records and develop,           |
|                            | disseminate and update reports |
|                            | to internal senior management, |
|                            | as well as external oversight  |
|                            | bodies, as appropriate, to     |
|                            | demonstrate accountability     |
|                            | with specific statutory        |
