...
|                            | capability to revoke user      |
|                            | access rights following        |
|                            | changes in personnel roles and |
|                            | duties, if no longer necessary |
|                            | or permitted.                  |
...
|                            | revoke user access rights      |
|                            | following changes in personnel |
|                            | roles and duties, if no longer |
