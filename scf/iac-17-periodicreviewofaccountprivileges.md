...
|                            | accounts to validate the       |
|                            | need for such privileges and   |
|                            | reassign or remove unnecessary |
...
|                            | and technologies review all    |
|                            | system accounts and disable    |
|                            | any account that cannot be     |
