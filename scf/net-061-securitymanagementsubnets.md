...
|                            | to isolate security tools and  |
|                            | support components from other  |
|                            | internal system components     |
|                            | by implementing separate       |
|                            | subnetworks with managed       |
...
|                            | subnets to isolate security    |
|                            | tools and support components   |
|                            | from other internal system     |
|                            | components by implementing     |
|                            | separate subnetworks with      |
|                            | managed interfaces to other    |
