...
|                            | capability to protect systems  |
|                            | from damage resulting from     |
|                            | water leakage by providing     |
|                            | master shutoff valves that are |
...
|                            | access. <br>- Administrative   |
|                            | processes and physical         |
|                            | controls address system        |
|                            | component location within the  |
...
|                            | by providing master shutoff    |
|                            | valves that are accessible,    |
|                            | working properly and known to  |
|                            | key personnel.                 |
