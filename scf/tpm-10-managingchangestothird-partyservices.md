...
|                            | capability to control changes  |
|                            | to services by suppliers,      |
...
|                            | by suppliers, taking into      |
|                            | account the criticality of     |
|                            | business information, systems  |
|                            | and processes that are in      |
|                            | scope by the third-party.      |
...
|                            | control changes to services by |
|                            | suppliers, taking into account |
|                            | the criticality of business    |
|                            | information, systems and       |
|                            | processes that are in scope by |
