...
|                            | to Cryptographic protect the   |
|                            | confidentiality and integrity  |
|                            | of information on mobile       |
|                            | devices through full-device or |
...
|                            | Management (MDM). o	Implement   |
|                            | and maintain a MDM capability  |
|                            | for all mobile devices in      |
...
|                            | data. •	MDM software is used    |
|                            | to restrict the data that is   |
...
|                            | Management (IAM) function,     |
|                            | or similar function, performs  |
|                            | the implementation of          |
|                            | access controls for mobile     |
|                            | devices that restricts the     |
|                            | connectivity of mobile devices |
|                            | from communicating with        |
|                            | systems, applications and      |
|                            | services. •	Organization-owned  |
|                            | mobile devices are configured  |
|                            | to protect data with the       |
|                            | strength and integrity         |
|                            | commensurate with the          |
|                            | classification or sensitivity  |
|                            | of the information stored on   |
|                            | the device, and conform to     |
|                            | industry-recognized standards  |
|                            | for hardening (e.g., DISA      |
|                            | STIGs, CIS Benchmarks or OEM   |
|                            | security guides), including    |
...
|                            | or applicable Bring Your Own   |
|                            | Device (BYOD) (e.g., personal  |
|                            | devices) across the entire     |
|                            | organization. •	MDM enforces    |
|                            | a separate device workspace    |
|                            | on applicable mobile devices   |
