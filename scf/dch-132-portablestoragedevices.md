...
|                            | capability to restrict or      |
|                            | prohibit the use of portable   |
|                            | storage devices by users on    |
|                            | external systems.              |
...
|                            | restrict or prohibit the use   |
|                            | of portable storage devices by |
|                            | users on external systems.     |
