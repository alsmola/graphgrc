...
|                            | technically possible. •	Asset   |
|                            | custodians are assigned        |
|                            | responsibilities that cover    |
|                            | change management duties,      |
|                            | including privileged access    |
|                            | to perform change management   |
|                            | actions. •	File Integrity       |
|                            | Monitoring (FIM) alerts are    |
|                            | investigated for unauthorized  |
|                            | changes. •	FIM alerts are       |
|                            | investigated for unauthorized  |
|                            | changes and are configured     |
|                            | to implement remediation       |
|                            | actions up on the detection    |
|                            | of unauthorized baseline       |
|                            | configurations change(s). •	FIM |
|                            | is deployed on systems that    |
|                            | store, process or transmit     |
|                            | sensitive/regulated/regulated  |
|                            | data to monitor the integrity  |
|                            | of business-critical files     |
|                            | for tampering. •	Endpoint       |
