...
|                            | capability to ensure network   |
|                            | architecture utilizes network  |
|                            | segmentation to isolate        |
|                            | systems, applications and      |
|                            | services that protections from |
...
|                            | require De-Militarized Zone    |
|                            | (DMZ) network segments to      |
|                            | separate untrusted networks    |
|                            | from trusted networks.         |
|                            | •	IT/cybersecurity architects   |
|                            | maintain a segmented           |
|                            | development network to         |
|                            | ensure a secure development    |
|                            | environment.                   |
...
|                            | ensure network architecture    |
|                            | utilizes network segmentation  |
|                            | to isolate systems,            |
|                            | applications and services that |
|                            | protections from other network |
|                            | resources.                     |
