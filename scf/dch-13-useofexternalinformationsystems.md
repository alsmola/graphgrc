...
|                            | capability to govern how       |
|                            | external parties, systems and  |
|                            | services are used to securely  |
|                            | store, process and transmit    |
|                            | data.                          |
| Performed internally       | SP-CMM1 is N/A, since a        |
|                            | structured process is required |
|                            | to govern how external         |
|                            | parties, systems and services  |
|                            | are used to securely store,    |
